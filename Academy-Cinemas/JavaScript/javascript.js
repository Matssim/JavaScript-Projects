...
//Shrink header size when the document is scrolled down by 80 pixels
$(document).on("scroll", function () {
    ...
    if ($(document).scrollTop() > 50) {
        ...
        //of the webpage has not been scrolled down or 
...
$(document).ready(function () {
    //Onclick when and element contains just the nav-link class and not the dropdown-toggle and then
