...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayeris equal to 'X', the x.png is placed in the HTML
        ...
        if (activePlayer === 'O') {
            ...
            disableClick();
            //This function waits 1 second (1000 milliseconds) before the computer places an image and enables click.
    ...
    function computersTurn() {
        //This booolean is needed for our while loop.
        let success = false;
...
//placement sound('./media/place2.mp3')
